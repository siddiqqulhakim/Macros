...
get_paper_code +=  "URL GOTO=https://www.paper.id/webappv1/#/invoicer/finance/digital-payment-out/payout" + "\n"; 
get_paper_code +=  "WAIT SECONDS=3" + "\n"; 
//get_paper_code +=  `EVENT TYPE=CLICK SELECTOR="#recipient-select>PAPER-LAZY-LOAD-DROPDOWN>FORM>NG-SELECT>DIV>SPAN" BUTTON=0` + "\n"; 
//get_paper_code +=  `EVENT TYPE=CLICK SELECTOR="#aafac1669cb3-0>DIV" BUTTON=0` + "\n"; 
...
get_paper_code +=  "TAG POS=1 TYPE=BUTTON ATTR=ID:payout-step5" + "\n"; 
get_paper_code +=  "WAIT SECONDS=3" + "\n"; 
...
get_paper_code +=  "WAIT SECONDS=1" + "\n"; 
get_paper_code +=  "TAG POS=1 TYPE=BUTTON ATTR=ID:payout-step8" + "\n"; 
get_paper_code +=  "WAIT SECONDS=1" + "\n"; 
get_paper_code +=  "TAG POS=1 TYPE=BUTTON ATTR=ID:payout-step9" + "\n"; 
get_paper_code +=  "WAIT SECONDS=1" + "\n"; 
...
get_paper_code +=  `SAVEAS TYPE=EXTRACT FOLDER={{!FOLDER_DATASOURCE}} FILE=result_paper.csv` + "\n"; 
